...
public class RabbitConfig {
    ...
    public static final String QUEUE_ORDERS = "queue-damon";
    public static final String EXCHANGE_ORDERS = "exchange-damon";
    private static final String QUEUE_DEAD_ORDERS = "dead-damon";
